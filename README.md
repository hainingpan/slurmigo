...
If you modify a parameter file and run again, slurmigo detects the content change (by hash) and asks whether to continue the previous session or start fresh. To skip the prompt and always start a new session:
